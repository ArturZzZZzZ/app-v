...
// Assuming you have a TokenBalance component
import { ethers } from "ethers";

import { ERC20ABI, VaultABI } from "../../../utils/ABIs";
...
function VaultTransaction() {
  ...
  async function getAssetBalance() {
    ...
    try {
      ...
      const assetContract = await new ethers.Contract(
        contractAddress,
        contractABI,
        signer
      );
          ...
          <TokenBalance
            ...
            label={
              action === "deposit"
                ...
                : selectedAsset.representationTokenName
            }
