...
import { useSetLiquidationOpenToPublic } from "@/utils/writeMehods";

export const SetLiquidationOpenToPublic = ({ setSnackbar }) => {
  const [inputValue, setInputValue] = useState("");
  const methodName = "setLiquidationOpenToPublic";
  ...
  const {
    ...
    loading: isLoading,
    value
  } = useSetLiquidationOpenToPublic(vaultId);
