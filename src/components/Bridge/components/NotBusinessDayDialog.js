...
const NotBusinessDayDialog = ({ open, onClose }) => (
    <Dialog open={open} onClose={onClose}>
        ...
        <DialogContent>
            ...
            <Typography paragraph>
                Please note that our service is available only on business days according to NYSE and Philadelphia Fed Calendars, Monday through Friday. Additionally, due to the need for balance reconciliation across various channels, the service will be temporarily unavailable each day from 2:45 pm to 3:05 pm EST.
            </Typography>
            <Typography paragraph>
