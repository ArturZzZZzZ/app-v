...
import {
  ...
  walletConnectTargetBlockchainConfig,
...
const WalletDisplay = ({ networkKey }) => {
  ...
  // Определяем, Solana ли выбрана
  const isSolana =
    networkKey === 'solana' ||
    (networkKey && blockchainInfo[networkKey]?.name === 'Solana');

  if (isSolana) {
    // Показываем Solana Wallet Connect UI
